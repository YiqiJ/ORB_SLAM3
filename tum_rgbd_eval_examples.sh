...
python evaluation/evaluate_ate_scale.py "$pathDatasetTUM_RGBD"/fr1_desk/rgbd_dataset_freiburg1_desk/groundtruth.txt CameraTrajectory_TUM.txt --plot fr1_desk_rgbd.pdf
...
# echo "Evaluation of Freiburg2 XYZ with RGB-D sensor"
# python evaluation/evaluate_ate_scale.py "$pathDatasetTUM_RGBD"/rgbd_dataset_freiburg2_xyz/groundtruth.txt CameraTrajectory_xyz.txt --plot fr2_xyz_rgbd.pdf
